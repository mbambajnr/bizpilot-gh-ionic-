  ...
  async function handleCheckout() {
    ...
    try {
      ...
      if (commerceRuntime?.mode === 'standalone') {
        if (!standaloneCustomerId) throw new Error('Choose a BisaPilot customer before completing this sale.');
