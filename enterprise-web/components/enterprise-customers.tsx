...
type CustomerFormInput = { name: string; clientId?: string; phone?: string; whatsapp?: string; email?: string; channel: string; customerType?: CustomerType; taxExempt?: boolean; taxExemptionReason?: string };
