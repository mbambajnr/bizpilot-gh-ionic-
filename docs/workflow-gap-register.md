...
| P1 | Fulfilment lifecycle | Waybills can be generated and printed but are not a dispatch workflow. | Add picking, packed, dispatched, delivered, failed-delivery, proof-of-delivery, and fulfilment ownership states. |
| P1 | Financial control | Receivables, payables, expenses, and payment records exist without bank reconciliation or accounting periods. | Add cashbook matching, bank reconciliation, period close, locked periods, and controlled adjustments. |
