...
vi.mock('../data/supabaseSync', () => ({
  ...
  syncExpenseForUser: vi.fn(() => Promise.resolve(true)),
  ...
  syncActivityLogEntry: vi.fn(() => Promise.resolve(true)),
  syncAppNotification: vi.fn(() => Promise.resolve(true)),
  syncAppNotificationRead: vi.fn(() => Promise.resolve(true)),
  syncAccountsPayableForUser: vi.fn(() => Promise.resolve(true)),
  syncPaymentForUser: vi.fn(() => Promise.resolve(true)),
  syncRestockRequestForUser: vi.fn(() => Promise.resolve(true)),
  syncStockTransferForUser: vi.fn(() => Promise.resolve(true)),
}));
